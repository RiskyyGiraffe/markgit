...
describe('API permissions', () => {
  ...
  it.each([
    ...
    ['POST', '/v1/harnesses/research/runs', 'harnesses:run'],
    ['GET', '/v1/harness-runs/run-id/events', 'harnesses:monitor'],
    ['POST', '/v1/harness-runs/run-id/feedback', 'tools:call'],
    ['POST', '/v1/harness-runs/run-id/consolidate-review', 'tools:call'],
    ['POST', '/v1/harnesses', 'harnesses:publish'],
    ['POST', '/v1/mcps', 'mcps:publish'],
    ['POST', '/v1/skills', 'tools:publish'],
    ['GET', '/v1/quicklist', 'registry:read'],
    ['PUT', '/v1/quicklist/weather', 'spend:write'],
    ['GET', '/v1/reviews/weather/eligibility', 'registry:read'],
    ['POST', '/v1/reviews/weather/usage', 'tools:call'],
    ['POST', '/v1/reviews/weather/feedback', 'tools:call'],
    ['POST', '/v1/reviews/weather/consolidate', 'tools:call'],
    ['PUT', '/v1/reviews/weather', 'tools:call'],
  ...
  it.each([
    ...
    ['POST', '/v1/harnesses'], ['POST', '/v1/harnesses/harness-slug/runs'], ['POST', '/v1/mcps'], ['POST', '/v1/skills'],
    ['GET', '/v1/quicklist'], ['PUT', '/v1/quicklist/tool-slug'], ['DELETE', '/v1/quicklist/tool-slug'],
    ['GET', '/v1/reviews/tool-slug/eligibility'], ['POST', '/v1/reviews/tool-slug/usage'],
    ['POST', '/v1/reviews/tool-slug/feedback'], ['POST', '/v1/reviews/tool-slug/consolidate'],
    ['PUT', '/v1/reviews/tool-slug'], ['DELETE', '/v1/reviews/tool-slug'],
    ['GET', '/v1/harness-runs'],
    ['GET', '/v1/harness-runs/run-id'], ['GET', '/v1/harness-runs/run-id/events'],
    ['POST', '/v1/harness-runs/run-id/cancel'],
    ['POST', '/v1/harness-runs/run-id/feedback'], ['POST', '/v1/harness-runs/run-id/consolidate-review'],
