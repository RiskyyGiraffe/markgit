...
export function ReviewControl({ identifier, initialEligibility, initialReviews }: { identifier: string; initialEligibility: ReviewEligibility; initialReviews: PublicReviewsResponse }) {
  ...
  async function attest() {
    ...
    try {
      await attestReviewUsage(identifier, agentName, "Direct use reported from the Markgit web account");
      setEligible(true); setMessage("Use recorded as agent-attested. You can review now.");
