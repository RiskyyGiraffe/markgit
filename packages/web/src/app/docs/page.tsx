      ...
      <div className="mx-auto max-w-5xl px-5 pb-24 pt-14 sm:px-8 sm:pt-20">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-[#92979a] sm:text-lg">
            Every listing says whether it is an atomic tool, durable harness, remote MCP server, or source-hosted skill. Skill docs expose provenance and compatibility without Markgit automatically installing or executing package code.
          </p>
        </div>
